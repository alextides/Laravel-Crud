                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <input type="text" id="PayorsGivenName"
                                                           ...
                                                           placeholder="Payor's Given Name(s)" required=""></div>
                                                <div class="col-md-6">
                                                    <input type="text" id="PayorsFamilyName"
                                                           data-name="PayorsFamilyName"
                                                           class="form-control inp-gstud"
                                                           name="PayorsFamilyName"
                                                           placeholder="Payor's Family Name" required=""></div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="ml-2">
                                                    <input type="email" id="PayorsEmail" data-name="PayorsEmail"
                                                           name="PayorsEmail" class="form-control inp-gstud" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="ml-2">
                                            <input type="text" id="PayorsPostalAddress" data-name="PayorsPostalAddress"
                                                   name="PayorsPostalAddress" class="form-control" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-7 mx-auto">
                                        <div class="form-group text-center">
                                            <label class="font-weight-bold mb-0">Your UCI (Unique Client
                                                Identifier)</label><br>
                                            <small>Forgot your UCI? Find it at the bottom of your previous Statement of Entry (<a href="javascript:void(0)"data-toggle="modal" data-target="#UciModal"><i aria-hidden="true"></i>example with UCI highlighted</a>)</small>
                                            <div class="ml-2 mt-1">
                                                ...
                                                <table id="bs-table" class="table table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th scope="col">Cash In? <a href="javascript:void(0)"
                                                                        ...
                                                                        aria-hidden="true"></i>View more information</a></th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
...
<!-- Forgot UCI Modal  -->
<div class="modal fade" id="UciModal" tabindex="-1" role="dialog" aria-labelledby="UciModalTitle"
     aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="UciModalTitle">Statement of Entry</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <embed src="<?= base_url ?>/assets/files/Sample_SoE_with_UCI.pdf" frameborder="0" width="100%" height="700px">
            </div>
        </div>
    </div>
</div>
